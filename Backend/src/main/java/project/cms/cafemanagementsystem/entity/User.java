...
@NamedQuery(name = "User.getAllAdmin", query = "select new project.cms.cafemanagementsystem.wrapper.UserWrapper(u.id, u.name, u.email, u.contactNumber, u.status) from User u where u.role = 'admin'")
@DynamicInsert
@DynamicUpdate
@Getter
@Setter
